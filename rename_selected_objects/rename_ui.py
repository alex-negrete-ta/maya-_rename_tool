...
def rename_groups_ui():
    ...
    rename_inst = (
        "Fill this with the name of the object type. ex. Mary, mary_arm, house, etc."
    )
    ...
    window = cmds.window(
        window_name, title="Rename Groups", widthHeight=(300, 180), sizeable=True
    )
    ...
    preffix_menu = cmds.optionMenuGrp(
        "preffix_omg",
        adjustableColumn=2,
        columnWidth=[(1, 100), (3, 100)],
        columnAlign=(1, "left"),
    ...
    suffix_menu = cmds.optionMenuGrp(
        "suffix_omg",
        adjustableColumn=2,
        columnWidth=[(1, 100), (3, 100)],
        columnAlign=(1, "left"),
    ...
    subsuffix_menu = cmds.optionMenuGrp(
        "subsuffix_omg",
        adjustableColumn=2,
        columnWidth=[(1, 100), (3, 100)],
        columnAlign=(1, "left"),
    ...
    b1 = cmds.button(
        label="Rename and Close", command=lambda *args: rename_groups_close(window)
    )
